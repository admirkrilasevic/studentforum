...
function Header(){
    ...
    return(
        <div className={styles.header}>
            <NavLink to={"/home"} className={styles.headerLinks} activeStyle={{color: '#0c1e66'}}>
                Home
            </NavLink>
            <span className={styles.title}>askIBU</span>
            <NavLink to={loggedIn ? "/account" : "/login"} className={styles.icons} activeStyle={{color: '#0c1e66'}}>
