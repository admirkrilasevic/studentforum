...
class QuestionService extends BaseService
{
    ...
    public function get_weeks_hottest_questions($status, $department_id)
    {
        ...
        $answers = $this->answerDao->get_answers(
            null,
            0,
            1000000000,
            $status,
    ...
    public function get_questions_for_departments(
        ...
        return  $this->dao->get_questions_for_departments(
            $limit,
            $offset,
            $order,
            $department_id,
    ...
    public function get_questions_for_course(
        ...
        return  $this->dao->get_questions_for_course(
            $limit,
            $offset,
            $order,
            $course_id,
    ...
    public function update_question($user, $id, $data)
    {
        ...
        if ($db_question["user_id"] != $user["id"]) {
            throw new Exception("Invalid question!", 403);
        }
